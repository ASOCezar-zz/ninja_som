...
import './styles.scss';
import closeModalIcon from '../../templates/icons/closeModal_icon.svg';
import seeMoreIcon from '../../templates/icons/seeMore_arrow_icon.svg';
...
export const WrapperModal = () => {
  ...
  return (
    <div ref={divModal} className="wrapperModal">
      <div className="modalBackground" onClick={() => setIsModalOpen(false)}></div>
      <div className="modal">
